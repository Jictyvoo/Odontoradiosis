...
function drawBezier(x1,y1,cx1,cy1,cx2,cy2,x2,y2){const div=document.getElementById('bezier');let ctx=div.getContext('2d');ctx.strokeStyle='#00e379';ctx.moveTo(x1,y1);ctx.bezierCurveTo(cx1,cy1,cx2,cy2,x2,y2);ctx.lineWidth=lineWidth;ctx.stroke()}
