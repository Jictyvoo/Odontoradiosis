...
const mousePosition=getMousePos(div,event);const offsets={left:$("#image").offset().left,top:$("#image").offset().top};global_points[currentPoint].X=mousePosition.x+offsets.left;global_points[currentPoint].Y=mousePosition.y+offsets.top;redrawLandmark(div);const data_json=landmarksToJSON(global_points);let hiddenForm=document.getElementById("saved_points");hiddenForm.setAttribute("value",data_json)}}
function desfazer(){}
