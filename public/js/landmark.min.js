...
addCanvasEvents(){let curveSelect=document.getElementById("curvesId");curveSelect.addEventListener("input",function(){const selectedIndex=document.getElementById("curvesId").selectedIndex;const currentCurve=document.getElementById("curvesId").options[selectedIndex].text;this.mainController.tracingController.drawCurveBox(currentCurve);this.mainController.tracingController.drawPointCircle(currentCurve);if(currentCurve!=="Selecione"){document.getElementById("stack-canvas").style.cursor="move"}else{document.getElementById("stack-canvas").style.cursor="crosshair"}})}
