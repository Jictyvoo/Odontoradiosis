...
function scaleDraw(canvas){const rect=canvas.getBoundingClientRect();const canvasDimensions={width:rect.width,height:rect.height};let ctx=document.getElementById('landmarks').getContext('2d');const imageDimensions={width:ctx.canvas.width,height:ctx.canvas.height};if(imageDimensions.width>imageDimensions.height){pointRadius=(imageDimensions.width*scaleDrawValue.pointRadius)/canvasDimensions.width;nameScale=(imageDimensions.width*scaleDrawValue.nameScale)/canvasDimensions.width;lineWidth=(imageDimensions.width*scaleDrawValue.lineWidth)/canvasDimensions.width}else{pointRadius=(imageDimensions.height*scaleDrawValue.pointRadius)/canvasDimensions.height;nameScale=(imageDimensions.height*scaleDrawValue.nameScale)/canvasDimensions.height;lineWidth=(imageDimensions.height*scaleDrawValue.lineWidth)/canvasDimensions.height}}
...
const mousePosition=getMousePos(div,event);global_points[currentPoint].X=mousePosition.x;global_points[currentPoint].Y=mousePosition.y;redrawLandmark(div);saveLandmarks(global_points)}}
function desfazer(){}
