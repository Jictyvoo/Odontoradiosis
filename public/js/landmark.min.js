...
function drawLandmark(div,landmarkName){const locations=global_points[landmarkName];let context=div.getContext('2d');context.beginPath();context.arc(locations.X,locations.Y,pointRadius,0,2*Math.PI);context.fillStyle='red';context.font=nameScale+"px Arial";context.fillText(landmarkName.match(/\(.+\)/),Math.floor(parseInt(locations.X)-10),Math.floor(parseInt(locations.Y)+20));context.fill();context.lineWidth=1;context.strokeStyle='#330005';context.stroke()}
