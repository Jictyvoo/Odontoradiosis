...
onChangeValue(){console.log(this.canvas);const imageElement=this.canvas.getCanvas("image");let filterValue=this.getValues();imageElement.setAttribute("style",filterValue)}
