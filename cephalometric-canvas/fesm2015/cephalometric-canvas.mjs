            ...
            for (const landmark of Object.entries(decodedLandmarks)) {
                ...
                if (typeof landmarkPosition == 'object') {
                    validLandmarks[landmarkName] = {
                        x: landmarkPosition === null || landmarkPosition === void 0 ? void 0 : landmarkPosition.x,
                        y: landmarkPosition === null || landmarkPosition === void 0 ? void 0 : landmarkPosition.y,
                    };
                }
            }
    ...
    constructor(routinesDescription, tracingController, landmarksController) {
        ...
        this.preFunctions = {
            ...
            access_point: function (firstParam, secondParam, resultName) {
                ...
                let counter = 0;
                for (let index = 0; index < ((_b = (_a = symbolTable[secondParam]) === null || _a === void 0 ? void 0 : _a.length) !== null && _b !== void 0 ? _b : 0); index++) {
                    const element = symbolTable[secondParam] != null
                        ? (_c = symbolTable[secondParam][index]) !== null && _c !== void 0 ? _c : ''
                        : '';
                    for (let subindex = 1; subindex < ((_d = element === null || element === void 0 ? void 0 : element.length) !== null && _d !== void 0 ? _d : 0); subindex += 2) {
                        counter++;
...
class CanvasOdontoradiosisImpl {
    ...
    addCanvasElement(canvasId, element) {
        ...
        element.setAttribute('style', UsefulMethods.canvasStyle((_a = this.layerSequence[canvasId]) !== null && _a !== void 0 ? _a : -1));
    }
    get scales() {
