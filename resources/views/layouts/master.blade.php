...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a align="middle" href="{{ route('home') }}" class="brand-link">
                <img width="200" height="133" src="{{ asset('img/odontoradiosis_logo.png') }}" alt="Odontoradiosis"
                    align="middle">
            </a>
        ...
        <footer class="main-footer">
            ...
            <strong>© 2018 <a href="https://github.com/argalvao/">Abel Ramalho Galvão</a> and <a
                    ...
                    href="http://php.net" target="_blank">PHP</a>
            </strong>
        </footer>
    </div>
    <!-- ./wrapper -->
    ...
    MinimizeJSController::minimizeAll('js/odontoradiosis/landmark_system', 'js/odontoradiosis.min.js');
    ?>

    <script src="{{ asset('js/odontoradiosis.min.js') }}"></script>
